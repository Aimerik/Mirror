...
/**
 *  * Returns an array containing all zeroResourceStart resource codes ordered as defined in the resource files.
 * @return {string[]} - Data of the form [ "food", "wood", ... ].
 */
Resources.prototype.GetZeroResourceStartCodes = function()
{
	return this.resourceCodesByProperty.zeroResourceStart || [];
};
